...
//                log.info("res: " + res);
    ...
    public void testGetSimilarity() {
        ...
        similarity = getSimilarity("花椒", "大料");
        System.out.println("花椒--" + "大料:" + similarity);

        similarity = getSimilarity("粥", "汤");
        System.out.println("粥--" + "汤:" + similarity);
        similarity = getSimilarity("糖", "盐");
        System.out.println("糖--" + "盐:" + similarity);
    }
